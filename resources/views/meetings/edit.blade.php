...
@section('content')
    <div class="container mb-5 pd-5">
        <div class="col-md-6 offset-md-3 mb-5 pd-5">
            ...
            <hr>
            {!! Form::model($meeting, ['url' => ['/meetings/' . $meeting->id]]) !!}

                {{ method_field('PATCH') }}

                <div class="form-group{{ $errors->has('municipality') ? ' has-error' : '' }}">
                    {!! Form::label('municipality', 'Municipio') !!}
                    {!! Form::select('municipality', [0 => 'Huauchinango', 1 => 'Zacatlán', 2 => 'Teziutlán', 3 => 'Ajalpan', 4 => 'San Martín Tezmelucán', 5 => 'Puebla 6', 6 => 'Tepeaca', 7 => 'Chalchicomula de Sesma', 8 => 'Cholula', 9 => 'Atlixco', 10 => 'Acatlán', 11 => 'Tehuacán', 12 => 'Puebla 9', 13 => 'Puebla 11', 14 => 'Puebla 12'], $meeting->getOriginal('municipality'), ['id' => 'municipality', 'class' => 'form-control', 'required' => 'required']) !!}
                ...
                <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                    ...
                    {!! Form::date('date', $meeting->date, ['class' => 'form-control', 'required' => 'required']) !!}
                    <small class="text-danger">{{ $errors->first('date') }}</small>
                </div>

                <div class="form-group{{ $errors->has('time') ? ' has-error' : '' }}">
                    {!! Form::label('time', 'Hora') !!}
                    {!! Form::time('time', $meeting->time, ['class' => 'form-control', 'required' => 'required']) !!}
                ...
                <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                    ...
                    {!! Form::select('status', [1 => 'Realizada', 2 => 'Programada'], $meeting->getOriginal('status'), ['id' => 'status', 'class' => 'form-control', 'required' => 'required']) !!}
