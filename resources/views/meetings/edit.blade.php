        ...
        <div class="col-md-6 offset-md-3 mb-5 pd-5">
            ...
            {!! Form::model($meeting, ['url' => ['/meetings/' . $meeting->id]]) !!}
                ...
                <div class="form-group{{ $errors->has('municipality') ? ' has-error' : '' }}">
                    ...
                    {!! Form::select('municipality', [0 => 'Huauchinango', 1 => 'Zacatlán', 2 => 'Teziutlán', 3 => 'Ajalpan', 4 => 'San Martín Tezmelucán', 5 => 'Puebla', 6 => 'Tepeaca', 7 => 'Chalchicomula de Sesma', 8 => 'Cholula', 9 => 'Atlixco', 10 => 'Acatlán', 11 => 'Tehuacán'], $meeting->getOriginal('municipality'), ['id' => 'municipality', 'class' => 'form-control', 'required' => 'required']) !!}
